...
public class MainActivityLive extends BaseActivity {
    @Override
    ...
    public void onClickJoin(View view) {
        ...
        builder.setNegativeButton(R.string.label_audience, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                MainActivityLive.this.forwardToLiveRoom(Constants.CLIENT_ROLE_AUDIENCE);
            }
        });
        builder.setPositiveButton(R.string.label_broadcaster, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                MainActivityLive.this.forwardToLiveRoom(Constants.CLIENT_ROLE_BROADCASTER);
            }
        });
    ...
    public void forwardToLiveRoom(int cRole) {
        ...
        Intent i = new Intent(MainActivityLive.this, LiveRoomActivity.class);
