...
public class BasicTests extends ActivityInstrumentationTestCase2<MainActivityLive> {

    private Solo solo;

    public BasicTests() {
        super(MainActivityLive.class);
    }
    ...
    public void testJoinAsBroadcaster() throws Exception {
        ...
        solo.assertCurrentActivity("Expected MainActivityLive activity", "MainActivityLive");
